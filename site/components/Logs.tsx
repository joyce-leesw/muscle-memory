          ...
          <div className="bg-white rounded-xl p-6 shadow-lg w-80 space-y-4">
            ...
            <div className="space-y-2">
              {workoutTypes.map((type, index) => (
                <button
                  key={index}
                  className="flex items-center gap-2 my-2 px-3 py-1 rounded hover:bg-gray-100 w-60"
            ...
            workoutsToday.map((log, index) => (
              <div key={index} className="px-2 text-left">
                <div className="flex justify-between items-center">
                  <div>
                    <div className="text-md text-gray-500">{log.name}</div>
                    <div className="flex space-x-4">
                      ...
                      <span className="w-15 justify-between">
                        <span className="text-lg font-bold text-sky-600 w-4">
                          {log.sets}
                        </span>
